Template.calendar.helpers({
    ...
    written: function() {
        ...
        var theMaxContribution_session;

        if (Session)
            theMaxContribution_session = Session.get("theMaxContribution");
        else
            theMaxContribution_session = 0;

        var theMaxContribution = parseFloat(theMaxContribution_session);
